...
transmitted_file_name = '.\Transmitted_PAM_data_40.mat'; % transmitted data for generator
load(transmitted_file_name); % import: symbol_rate, transmitted_symbol

received_file_name = '.\oscilloscope_40.mat'; % received signal from oscilloscope in Matlab format
