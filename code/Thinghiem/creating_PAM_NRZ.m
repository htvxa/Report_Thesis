...
bit_rate = 100000; % bit per second, use to calculate the frequency of the arbitrary singal generator, change if needed
number_of_transmitted_symbol = 250;
 % number of transmitted m-PAM symbols and pilot symbols, change if needed
...
%     visaAddress = 'USB::0x0699::0x0356::C020110::INSTR'; % Use VISA 'Instrument Manager - Properties' to find the USB port address
    ...
    fprintf(myFgen, 'SOUR1:FREQ:FIXed 400Hz'); % Set the output frequency to 1 Hz to avoid further upconverted by AFG
fprintf(myFgen, 'SOUR2:FREQ:FIXed 400Hz');
